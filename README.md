...
The `agentcmd` CLI allows you to create, publish, update, install and monitor agents like you would with code. Configurations support all types of agentic concepts such as MCP, skills, context, steering files, SOPs, tool permissions, etc. 
